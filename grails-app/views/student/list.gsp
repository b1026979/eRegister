			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="studentNotes" title="${message(code: 'student.studentNotes.label', default: 'Student Notes')}" />
				...
				<g:each in="${studentInstanceList}" status="i" var="studentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: studentInstance, field: "studentNotes")}</td>
