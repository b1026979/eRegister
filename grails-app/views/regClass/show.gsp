			...
			<ol class="property-list regClass">
				...
				<li class="fieldcontain">
					<span id="classInstructor-label" class="property-label"><g:message code="regClass.classInstructor.label" default="Class Instructor" /></span>
						...
						<span class="property-value" aria-labelledby="classInstructor-label"><g:link controller="instructor" action="show" id="${regClassInstance?.classInstructor?.id}">${regClassInstance?.classInstructor?.name.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="course-label" class="property-label"><g:message code="regClass.course.label" default="Course" /></span>
						...
						<span class="property-value" aria-labelledby="course-label"><g:link controller="course" action="show" id="${regClassInstance?.course?.id}">${regClassInstance?.course?.courseName.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="enrolledStudents-label" class="property-label"><g:message code="regClass.enrolledStudents.label" default="Enrolled Students" /></span>
						...
						<span class="property-value" aria-labelledby="enrolledStudents-label"><g:link controller="enrollment" action="show" id="${e.id}">${e?.student?.fullStudentName.encodeAsHTML()}</g:link></span>
						</g:each>
				...
				<li class="fieldcontain">
					<span id="name-label" class="property-label"><g:message code="regClass.name.label" default="Class Name" /></span>
