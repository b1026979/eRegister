	...
	<body>
		...
		<div id="show-course" class="content scaffold-show" role="main">
			...
			<ol class="property-list course">
				...
				<li class="fieldcontain">
					<span id="classes-label" class="property-label"><g:message code="course.classes.label" default="Classes and IDs" /></span>
					
						<g:each in="${courseInstance.classes}" var="c">
						<span class="property-value" aria-labelledby="classes-label"><g:link controller="regClass" action="show" id="${c.id}">${c?.name.encodeAsHTML()}, ${c?.id.encodeAsHTML()}</g:link></span>
						</g:each>
