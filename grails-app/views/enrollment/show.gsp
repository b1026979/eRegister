			...
			<ol class="property-list enrollment">
				...
				<li class="fieldcontain">
					<span id="regClass-label" class="property-label"><g:message code="enrollment.regClass.label" default="Reg Class" /></span>
						...
						<span class="property-value" aria-labelledby="regClass-label"><g:link controller="regClass" action="show" id="${enrollmentInstance?.regClass?.id}">${enrollmentInstance?.regClass?.name.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="student-label" class="property-label"><g:message code="enrollment.student.label" default="Student" /></span>
						...
						<span class="property-value" aria-labelledby="student-label"><g:link controller="student" action="show" id="${enrollmentInstance?.student?.id}">${enrollmentInstance?.student?.fullStudentName.encodeAsHTML()}</g:link></span>
